	             ...
	             <ul class="nav navbar-nav">
	              ...
	              <li class="dropdown">
	                     ...
	                     <ul class="dropdown-menu">
	                         <li><a href="#" id="sgr">개인정보조회</a></li>
	                         
	                         <c:if test="${sessionScope.user.role == 'admin'}">
	                         	<li><a href="#" id="sgr">회원정보조회</a></li>
	                         </c:if>
	              ...
	              <!-- 판매상품관리 DrowDown  -->
	               <c:if test="${sessionScope.user.role == 'admin'}">
		              <li class="dropdown">
		                     ...
		                     <ul class="dropdown-menu" >
		                         <li><a href="#" id="sgr">판매상품등록</a></li>
		                         <li><a href="#" id="sgr">판매상품관리</a></li>
	              ...
	              <li class="dropdown">
	                     ...
	                     <ul class="dropdown-menu">
	                         <li><a href="#" id="sgr">상 품 검 색</a></li>
	                         
	                         <c:if test="${sessionScope.user.role == 'user'}">
	                           <li><a href="#" id="sgr">구매이력조회</a></li>
	                         </c:if>
	                         
	                         <li><a href="#" id="sgr">최근본상품</a></li>
